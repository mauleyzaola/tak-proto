...
func (*LocationList) Descriptor() ([]byte, []int) {
	return fileDescriptor_location_service_31bb0ca1b561e257, []int{0}
}
...
type LocationServiceClient interface {
	...
	Load(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Location, error)
...
func (c *locationServiceClient) Load(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Location, error) {
	out := new(Location)
...
type LocationServiceServer interface {
	...
	Load(context.Context, *Request) (*Location, error)
...
func _LocationService_Load_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).Load(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() {
	proto.RegisterFile("location-service.proto", fileDescriptor_location_service_31bb0ca1b561e257)
}

var fileDescriptor_location_service_31bb0ca1b561e257 = []byte{
	...
	0x45, 0x41, 0x08, 0x69, 0xa3, 0xe5, 0x4c, 0x5c, 0xfc, 0x30, 0xf1, 0x60, 0x88, 0x43, 0x84, 0x94,
	0xb9, 0x58, 0x02, 0x32, 0xf3, 0xd2, 0x85, 0xb8, 0x41, 0x9a, 0x82, 0x20, 0x56, 0x4b, 0xf1, 0x40,
	0x38, 0x10, 0x8b, 0x95, 0x18, 0x40, 0x8a, 0x7c, 0xf2, 0x13, 0x53, 0xb0, 0x28, 0x82, 0x19, 0xa7,
	0xc4, 0x20, 0xa4, 0xc6, 0xc5, 0xe6, 0x5c, 0x94, 0x9a, 0x58, 0x92, 0x2a, 0x84, 0x22, 0x83, 0x61,
	0x98, 0x1a, 0x17, 0x5b, 0x68, 0x41, 0x0a, 0x51, 0xea, 0x82, 0x52, 0x73, 0xf3, 0xcb, 0x08, 0xa9,
	0xd3, 0xe0, 0x62, 0x01, 0x87, 0x04, 0xaa, 0x2a, 0x01, 0x64, 0x1e, 0x48, 0x1e, 0xac, 0x92, 0x23,
	0x2c, 0x31, 0x27, 0x93, 0xb0, 0xdd, 0x49, 0x6c, 0xe0, 0xc0, 0x36, 0x06, 0x04, 0x00, 0x00, 0xff,
	0xff, 0xd2, 0xaa, 0x40, 0x84, 0xb9, 0x01, 0x00, 0x00,
}
