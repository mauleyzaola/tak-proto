...
func (*InventoryRecordList) Descriptor() ([]byte, []int) {
	return fileDescriptor_inventory_record_service_6bd1a59014b94cc5, []int{0}
}
...
type GridInvRecordRequest struct {
	...
	Params               *InvRecParams `protobuf:"bytes,2,opt,name=params,proto3" json:"params,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*GridInvRecordRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_inventory_record_service_6bd1a59014b94cc5, []int{1}
}
...
func (m *GridInvRecordRequest) GetParams() *InvRecParams {
	if m != nil {
		return m.Params
	}
	return nil
...
func (*GridInvRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_inventory_record_service_6bd1a59014b94cc5, []int{2}
}
...
type InvRecParams struct {
	...
	Suppliers            []string             `protobuf:"bytes,5,rep,name=suppliers,proto3" json:"suppliers,omitempty"`
	Batch                string               `protobuf:"bytes,6,opt,name=batch,proto3" json:"batch,omitempty"`
	MinQty               float64              `protobuf:"fixed64,7,opt,name=minQty,proto3" json:"minQty,omitempty"`
...
func (m *InvRecParams) Reset()         { *m = InvRecParams{} }
func (m *InvRecParams) String() string { return proto.CompactTextString(m) }
func (*InvRecParams) ProtoMessage()    {}
func (*InvRecParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_inventory_record_service_6bd1a59014b94cc5, []int{3}
}
func (m *InvRecParams) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_InvRecParams.Unmarshal(m, b)
}
func (m *InvRecParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_InvRecParams.Marshal(b, m, deterministic)
}
func (dst *InvRecParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InvRecParams.Merge(dst, src)
}
func (m *InvRecParams) XXX_Size() int {
	return xxx_messageInfo_InvRecParams.Size(m)
}
func (m *InvRecParams) XXX_DiscardUnknown() {
	xxx_messageInfo_InvRecParams.DiscardUnknown(m)
}

var xxx_messageInfo_InvRecParams proto.InternalMessageInfo

func (m *InvRecParams) GetCodes() string {
	if m != nil {
		return m.Codes
	}
	return ""
...
func (m *InvRecParams) GetLocations() []string {
	if m != nil {
		return m.Locations
	}
	return nil
...
func (m *InvRecParams) GetFrom() *timestamp.Timestamp {
	if m != nil {
		return m.From
	}
	return nil
...
func (m *InvRecParams) GetTo() *timestamp.Timestamp {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *InvRecParams) GetSuppliers() []string {
	if m != nil {
		return m.Suppliers
	}
	return nil
...
func (m *InvRecParams) GetBatch() string {
	if m != nil {
		return m.Batch
	}
	return ""
...
func (m *InvRecParams) GetMinQty() float64 {
	if m != nil {
		return m.MinQty
	}
	return 0
...
func (m *InvRecParams) GetMaxQty() float64 {
	if m != nil {
		return m.MaxQty
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*InvRecParams)(nil), "pb.InvRecParams")
}
...
func init() {
	proto.RegisterFile("inventory-record-service.proto", fileDescriptor_inventory_record_service_6bd1a59014b94cc5)
}

var fileDescriptor_inventory_record_service_6bd1a59014b94cc5 = []byte{
	// 478 bytes of a gzipped FileDescriptorProto
	,
}
