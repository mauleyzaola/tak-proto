...
func (*LabBatchList) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_28a6936f233b45c8, []int{0}
}
...
func (*GridBatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_28a6936f233b45c8, []int{1}
}
...
func (*GridBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_28a6936f233b45c8, []int{2}
}
...
func (*BatchParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_28a6936f233b45c8, []int{3}
}
...
func (*ExportRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_28a6936f233b45c8, []int{4}
}
...
type LabBatchServiceClient interface {
	...
	Export(ctx context.Context, in *ExportRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *labBatchServiceClient) Export(ctx context.Context, in *ExportRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type LabBatchServiceServer interface {
	...
	Export(context.Context, *ExportRequest) (*Response, error)
}
...
func init() {
	proto.RegisterFile("lab-batch-service.proto", fileDescriptor_lab_batch_service_28a6936f233b45c8)
}

var fileDescriptor_lab_batch_service_28a6936f233b45c8 = []byte{
	// 559 bytes of a gzipped FileDescriptorProto
	,
}
