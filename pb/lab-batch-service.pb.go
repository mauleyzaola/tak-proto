...
func (*BatchCodeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_4dfed691ca2dbdac, []int{0}
}
...
func (*LabBatchList) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_4dfed691ca2dbdac, []int{1}
}
...
func (*GridBatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_4dfed691ca2dbdac, []int{2}
}
...
func (*GridBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_4dfed691ca2dbdac, []int{3}
}
...
func (*BatchParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_4dfed691ca2dbdac, []int{4}
}
...
func init() {
	proto.RegisterFile("lab-batch-service.proto", fileDescriptor_lab_batch_service_4dfed691ca2dbdac)
}

var fileDescriptor_lab_batch_service_4dfed691ca2dbdac = []byte{
	// 602 bytes of a gzipped FileDescriptorProto
	,
}
