...
func (*LabBatchList) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_cb00765e5f58c7e6, []int{0}
}
...
func (*GridBatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_cb00765e5f58c7e6, []int{1}
}
...
func (*GridBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_cb00765e5f58c7e6, []int{2}
}
...
func (*BatchParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_lab_batch_service_cb00765e5f58c7e6, []int{3}
}
...
func init() {
	proto.RegisterFile("lab-batch-service.proto", fileDescriptor_lab_batch_service_cb00765e5f58c7e6)
}

var fileDescriptor_lab_batch_service_cb00765e5f58c7e6 = []byte{
	// 499 bytes of a gzipped FileDescriptorProto
	,
}
